...
- **📊 Rich Excel Export (`.xlsx`) & Selective Export (ระบบเลือกรายการเพื่อส่งออก):**
  - **Check Box เลือกลายแถว (Selective Export):** สามารถติ๊ก Checkbox หน้ารายการที่ต้องการ หรือติ๊ก Select All ด้านบน เพื่อ Export เฉพาะรายการที่เลือกได้ทันที
  - **ปุ่มและตัวนับสถานะแบบ Real-time:** แสดงจำนวนรายการที่เลือก (เช่น `Export เฉพาะที่เลือก (3 รายการ)`) หรือหากไม่ติ๊กจะ Export ทั้งหมดโดยอัตโนมัติ
  - **ฝัง Thumbnail และลิงก์รูปภาพ:** ดึงรูปภาพจาก Cloudflare R2 / D1 มาฝังเป็น **ภาพ Thumbnail ขนาด 50x50px** ในเซลล์ Excel พร้อมสร้าง **URL ลิงก์รูปภาพ HTTPS แบบเต็ม** ที่คลิกเปิดดูภาพต้นฉบับได้ทันที
